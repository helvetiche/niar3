...
export function WorkspaceCalendar({ variant = "page" }: WorkspaceCalendarProps) {
  ...
  return (
    <section className={sectionClass}>
        ...
        <header className={isDrawer ? "mb-4" : "mb-6"}>
          ...
          >
            <span className="inline-flex items-center justify-center rounded-lg border-2 border-dashed border-white bg-white/10 p-1.5">
              <NotePencilIcon size={isDrawer ? 18 : 20} className="text-white" />
            </span>
            Calendar & Notes
          </h2>
        ...
        <div className="mt-4 flex shrink-0 flex-col gap-3 rounded-lg border border-emerald-700 bg-emerald-950/50 p-4">
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-2">
              <ListChecksIcon size={18} weight="duotone" className="text-white" />
                  ...
                  >
                    <p
                      className={`mb-2 text-xs font-semibold uppercase tracking-wider ${
                        bucket === "nearest" ? "text-white" : "text-white/70"
                      }`}
                    >
                      {label}
                    </p>
      ...
      {addModalDate && (
        <MasonryModal isOpen={!!addModalDate} onClose={() => setAddModalDate(null)}>
          {(close) => (
              ...
              <div className="mb-4 flex items-start gap-3">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="mt-0.5 text-sm text-white/70">
                    Add a note or reminder for this date. Choose a color to categorize
                    it.
                  </p>
                </div>
              </div>
