...
type ConsolidationSettingsProps = {
  ...
  onCreateConsolidationChange: (checked: boolean) => void;
  onCreateMergedConsolidationChange: (checked: boolean) => void;
  onConsolidationTemplateIdChange: (id: string) => void;
  onMergedConsolidationFileNameChange: (name: string) => void;
};
...
export function ConsolidationSettings({
  ...
  onConsolidationTemplateIdChange,
  onMergedConsolidationFileNameChange,
        ...
        <div className="mt-4 grid gap-4 md:grid-cols-2">
          <label className="block">
            ...
            <select
              ...
              onChange={(event) =>
                onConsolidationTemplateIdChange(event.target.value)
              }
          ...
          <div className="md:col-span-2 rounded-lg border border-white/30 bg-white/10 p-3">
            <label className="flex cursor-pointer items-start gap-3">
              <input
                ...
                onChange={(event) =>
                  onCreateMergedConsolidationChange(event.target.checked)
                }
            ...
            {createMergedConsolidation && (
              <label className="mt-3 block">
                ...
                <input
                  ...
                  onChange={(event) =>
                    onMergedConsolidationFileNameChange(event.target.value)
                  }
