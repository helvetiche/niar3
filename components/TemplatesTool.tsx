    ...
    <section className="flex h-full w-full flex-col rounded-2xl border border-emerald-700/60 bg-emerald-900 p-4 shadow-xl shadow-emerald-950/30 sm:p-6">
      <div className="mb-6">
        ...
        <p className="mt-2 text-sm text-white/85 text-justify">
          Use this page as the centralized template workspace for Generate Billing Unit
          and Accomplishment Report. You can review saved templates, select active ones,
          upload replacements, rename outdated files, and keep a clean list that stays
          consistent for every authenticated user. This prevents duplicate uploads per
          account, improves alignment across teams, and keeps all template-driven
          outputs standardized from one controlled place.
        </p>
      </div>
